...
module Tester2 = IterUtilsFn(ListIterator)
let itr2  = Tester.create lst
TEST_UNIT "TAKE" =
assert_true (Tester2.has_next itr2) 
TEST_UNIT "Next_1" =
assert_true (Tester2.has_next itr2)
TEST_UNIT "Next_2" =
assert_true ((Tester2.next itr2) = 1)
TEST_UNIT "Next_3" =
assert_true (Tester2.has_next itr)
TEST_UNIT "Next_4" =
assert_true ((Tester2.next itr2) = 2)
TEST_UNIT "Next_5" =
assert_true (Tester2.has_next itr2)
TEST_UNIT "Next_6" =
assert_true ((Tester2.next itr2) = 3)
TEST_UNIT "Next_7" =
assert_false (Tester2.has_next itr2) 
